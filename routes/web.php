...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/penjadwalan/generate-judul', [ArtikelController::class, 'generateJudul'])->name('penjadwalan.generate-judul');
    Route::post('/penjadwalan/generate-konten', [ArtikelController::class, 'generateKonten'])->name('penjadwalan.generate-konten');
